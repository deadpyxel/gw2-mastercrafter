...
type Recipe struct {
	...
	Disciplines     StringSlice  `json:"disciplines" db:"disciplines"`
...
type MerchantOptions struct {
	...
	Count  int             `json:"count" db:"count"`
	Price  []MerchantPrice `json:"price" db:"price"`
	Ignore bool            `json:"ignore,omitempty" db:"ignore"`
}

type Merchant struct {
	Name            string            `json:"name" db:"name"`
	Locations       StringSlice       `json:"locations" db:"location"`
	DisplayName     string            `json:"display_name,omitempty" db:"display_name"`
	PurchaseOptions []MerchantOptions `json:"purchase_options"`
}
